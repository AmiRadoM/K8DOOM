...
class Weapon(AnimatedSprite):
    def __init__(self, game, path="resources/sprites/weapon/shotgun/0.png", scale=0.09, animation_time=90):
        ...
        self.weapon_pos = (RESOLUTION[0]//2 - self.images[0].get_width()//2, RESOLUTION[1] - self.images[0].get_height())
